#!/bin/zsh
# ISA-Ollama Zsh-specific Functions
# Zsh implementation of Ollama client functions
...
# Zsh doesn't need export -f, functions are available globally by default
# However, we need to ensure the function names are available
# Add function names to fpath or use autoload if needed