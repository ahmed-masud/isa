...
class CommandIntentMapper:
    ...
    COMMAND_PATTERNS = {
        ...
        'new': {
            'aliases': ['create', 'make', 'add', 'setup', 'initialize', 'init'],
            'patterns': [
                'new context',
                'create context',
                'make context',
                ...
                'create places context',
                'create thing context',
                'create things context',
                'new person',
                'new place',
                'new thing',
                'add person',
                ...
                'make and switch',
                'new and switch',
                'create context and switch',
                'make context and switch'
            ],
            'description': 'Create a new context and optionally switch to it',
            'requires_arg': True,
            'complex_args': True
        }
    }
